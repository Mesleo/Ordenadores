...
/**
 * Clase que muestra ordenadores de Sobremesa según el número de serie introducido en la búsqueda
 * 
...
public class MostrarPorNumeroDeSerieSobremesa extends Mostrar {
	...
	/**
	 * Contructor de la ventana MostrarPorNumeroDeSerieSobremesa
	 * 
