...
/**
 * Clase qe muestra los ordenadores por piezas según el número de serie introducido en la búsqueda
 * 
 * @author Javier Benítez del Pozo
 *
 */
public class MostrarPorNumeroDeSerieComponentes extends Mostrar {
	...
	/**
	 * Contructor de la ventana MostrarPorNumeroDeSerieComponentes
	 * 
	 * @param almacen Almacén de TiendaOrdenador
	 */
	public MostrarPorNumeroDeSerieComponentes(final TiendaOrdenador almacen) {
		super(almacen);
		...
		buscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Ordenador ordenador = almacen.get((Ordenador)new PropioPC(textField.getText()));
