...
/**
 * Clase que muestra Portátiles según el número de serie introducido en la búsqueda
 * 
 * @author Javier Benítez del Pozo
 *
 */
public class MostrarPorNumeroDeSeriePortatil extends Mostrar {
	...
	/**
	 * Contructor de la ventana MostrarPorNumeroDeSeriePortatil
	 * 
	 * @param almacen Almacén de TiendaOrdenador
	 */
	public MostrarPorNumeroDeSeriePortatil(final TiendaOrdenador almacen) {
		super(almacen);
		...
		buscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Ordenador ordenador = almacen.get((Ordenador)new Portatil(textField.getText()));
